...
# IK Setup
# =================================================================================================
class ANIME_HAIR_TOOLS_OT_create_x_mirror_segments(bpy.types.Operator):
    bl_idname = "anime_hair_tools.create_x_mirror_segments"
    bl_label = "Create X-Mirror segments"
